  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_ghlnmlh',
      {
        ...
        to_email: 'olamigokeadebayo0@gmail.com',
      ...
      >
        ...
        >
          <label className="flex flex-col">
            ...
            className="bg-tertiary py-4 px-6 placeholder:text-secondary textwhite rounded-lg outlined-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
